...
<footer>
  ...
  <button id="btn-discord" class="btn btn-primary" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBottom" aria-controls="offcanvasBottom">
    <img src="./assets/pack_graphique/Discord.png" alt="Boutton d'accès aux réseaux sociaux" height="100">
  </button>
